...
public class Canvas {
     ...
     * foreground color of the canvas.
     *
     * @param xPos The x coordinate of the upper-left corner of the framing
     * rectangle of the semicircle
     * @param yPos The y coordinate of the upper-left corner of the framing
     * rectangle of the semicircle
     * @param width The overall width of the full circle of which this
     * semicircle is a partial section
     * @param height The overall height of the full circle of which this
     * semicircle is a partial section
     * @param verticalMidLine if true, the line bounding the semicircle will be
     * vertical
     * @param leftFacing if true and vertical, arc will point left. if true and
     * horizontal, arc will point upwards
     */
    ...
    /**
     * Erase the internal dimensions of the given triangle. The order of the
     * points provided is not relevant.
     *
     * @param xP1 The x coordinate of the first point of the triangle
     * @param yP1 The y coordinate of the first point of the triangle
     * @param xP2 The x coordinate of the second point of the triangle
    ...
    /**
     * Erase the internal dimensions of the given polygon The points should be
     * given in a cycle.
     *
     * @param xPoints The x coordinates for all the points in the polygon
     * @param yPoints The y coordinates for all the points in the polygon
